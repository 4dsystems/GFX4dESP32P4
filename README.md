...
2.  This is tested against Arduino ESP32 Core version `3.3.7`.

In case of any issues, please don't hesitate to [write an issue](https://github.com/4dsystems/GFX4dESP32P4/issues/new) or contact us directly.
