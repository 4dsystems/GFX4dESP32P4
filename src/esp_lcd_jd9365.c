...
{
    ESP_LOGI(TAG, "esp_lcd_new_panel_jd9365 called");

    // ESP_LOGI(TAG, "version: %d.%d.%d", ESP_LCD_JD9365_VER_MAJOR, ESP_LCD_JD9365_VER_MINOR, ESP_LCD_JD9365_VER_PATCH);
...
esp_err_t panel_jd9365_swap(esp_lcd_panel_t *panel, bool swap_x, bool swap_y)
{
    jd9365_panel_t *jd9365 = (jd9365_panel_t *)panel->user_data;
    esp_lcd_panel_io_handle_t io = jd9365->io;
    uint8_t madctl_val = jd9365->madctl_val;
