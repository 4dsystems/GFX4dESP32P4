...
public:
	...
	void DrawFrameBufferAreaScaleRotate(int fb, int fx, int fy, float fw, float fh, int deg, float scW, float scH, bool mirX, bool mirY, int altX, int altY);
    ...
    void UserImagesScale(uint16_t ui, int frame, int scW, int scH, bool mirX, bool mirY, int altx = 0x7fff, int alty = 0x7fff);
	void UserImagesRotate(uint16_t ui, int frame, int angle, bool mirX, bool mirY, int altx = 0x7fff, int alty = 0x7fff);
	void UserImagesScaleRotate(uint16_t ui, int frame, int scW, int scH, int angle, bool mirX, bool mirY, int altx = 0x7fff, int alty = 0x7fff);
	void UserImageScale(uint16_t ui, int scW, int scH, bool mirX, bool mirY, int altx = 0x7fff, int alty = 0x7fff);
	void UserImageRotate(uint16_t ui, int angle, bool mirX, bool mirY, int altx = 0x7fff, int alty = 0x7fff);
	void UserImageScaleRotate(uint16_t ui, int scW, int scH, int angle, bool mirX, bool mirY, int altx = 0x7fff, int alty = 0x7fff);
	void UserImageSRM(uint16_t ui, int ofst, int frame, int scW, int scH, int angle, bool mirX, bool mirY, int altx, int alty);
	void drawPPAobject(const uint8_t *sourceBuf, float sWidth, float sHeight, float scWidth, float scHeight, int deg, bool mirX, bool mirY, int x, int y, bool bSwap);
	void drawPPAobject(uint8_t *sourceBuf, float sWidth, float sHeight, float scWidth, float scHeight, int deg, bool mirX, bool mirY, int x, int y, bool bSwap);
