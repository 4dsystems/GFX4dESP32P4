...
//			:     begin(40);                        // set display clock to 40Mhz
//			:     begin(false);                     // start with backlight off
//			:     begin(40, false);                 // start at 40Mhz and backlight off
//
...
void gfx.UserImagesScale(ui, frame, scW, scH, mirX, mirY, [, altx, alty]), void; // Draw Userimages with scaling and mirror defined by output window
// Syntax	: gfx.UserImagesScale(ui, frame, scW, scH, mirX, mirY);
//			: gfx.UserImagesScale(ui, frame, scW, scH, mirX, mirY, altx, alty);
// Usage	: gfx.UserImagesScale(iUserimages1, 10, 100, 100, false, false);
// 			: gfx.UserImagesScale(iUserimages1, 10, 100, 100, false, false, 200, 400);
// Notes	: Draw a scaled Userimages using scW - scaled width and scH scaled Height.
//			: Mirror can be enabled with setting mirX and mirY to true for x and y mirror.
//			: Default Userimages position can be overridden with altx, alty
//

void gfx.UserImagesRotate(ui, frame, angle, mirX, mirY, [, altx, alty]), void; // Draw Userimages with rotation and mirror defined
// Syntax	: gfx.UserImagesRotate(ui, frame, angle, mirX, mirY);
//			: gfx.UserImagesRotate(ui, frame, angle, mirX, mirY, altx, alty);
// Usage	: gfx.UserImagesRotate(iUserimages1, 10, 270, false, false);
// 			: gfx.UserImagesRotate(iUserimages1, 10, 270, false, false, 200, 400);
// Notes	: Draw a rotated Userimages using angle 0, 90, 180, 270.
//			: Mirror can be enabled with setting mirX and mirY to true for x and y mirror.
//			: Default Userimages position can be overridden with altx, alty
//

void gfx.UserImagesScaleRotate(ui, frame, scW, scH, angle, mirX, mirY, [, altx, alty]), void; // Draw Userimages with scaling, rotate and mirror defined by output window
// Syntax	: gfx.UserImagesScaleRotate(ui, frame, scW, scH, angle, mirX, mirY);
//			: gfx.UserImagesScaleRotate(ui, frame, scW, scH, mirX, angle, mirY, altx, alty);
// Usage	: gfx.UserImagesScaleRotate(iUserimages1, 10, 100, 100, 90, false, false);
// 			: gfx.UserImagesScaleRotate(iUserimages1, 10, 100, 100, 90, false, false, 200, 400);
// Notes	: Draw a rotated, scaled Userimages using scW - scaled width and scH scaled Height and angle rotation.
//			: Mirror can be enabled with setting mirX and mirY to true for x and y mirror.
//			: Default Userimages position can be overridden with altx, alty
//

void gfx.UserImageScale(ui, scW, scH, mirX, mirY, [, altx, alty]), void; // Draw Userimage with scaling and mirror defined by output window
// Syntax	: gfx.UserImageScale(ui, scW, scH, mirX, mirY);
//			: gfx.UserImageScale(ui, scW, scH, mirX, mirY, altx, alty);
// Usage	: gfx.UserImageScale(iUserimage1, 100, 100, false, false);
// 			: gfx.UserImageScale(iUserimage1, 100, 100, false, false, 200, 400);
// Notes	: Draw a scaled Userimage using scW - scaled width and scH scaled Height.
//			: Mirror can be enabled with setting mirX and mirY to true for x and y mirror.
//			: Default Userimage position can be overridden with altx, alty
//

void gfx.UserImageRotate(ui, angle, mirX, mirY, [, altx, alty]), void; // Draw Userimage with rotation and mirror defined
// Syntax	: gfx.UserImageRotate(ui, angle, mirX, mirY);
//			: gfx.UserImageRotate(ui, angle, mirX, mirY, altx, alty);
// Usage	: gfx.UserImageRotate(iUserimage1, 270, false, false);
// 			: gfx.UserImageRotate(iUserimage1, 270, false, false, 200, 400);
// Notes	: Draw a rotated Userimage using angle 0, 90, 180, 270.
//			: Mirror can be enabled with setting mirX and mirY to true for x and y mirror.
//			: Default Userimage position can be overridden with altx, alty
//

void gfx.UserImageScaleRotate(ui, scW, scH, angle, mirX, mirY, [, altx, alty]), void; // Draw Userimage with scaling, rotate and mirror defined by output window
// Syntax	: gfx.UserImageScaleRotate(ui, scW, scH, angle, mirX, mirY);
//			: gfx.UserImageScaleRotate(ui, scW, scH, mirX, angle, mirY, altx, alty);
// Usage	: gfx.UserImageScaleRotate(iUserimage1, 10, 100, 100, 90, false, false);
// 			: gfx.UserImageScaleRotate(iUserimage1, 10, 100, 100, 90, false, false, 200, 400);
// Notes	: Draw a rotated, scaled Userimage using scW - scaled width and scH scaled Height and angle rotation.
//			: Mirror can be enabled with setting mirX and mirY to true for x and y mirror.
//			: Default Userimage position can be overridden with altx, alty
//
