...
//#include "gfx4desp32_ESP32_P4_70CT_CLB.h"

//gfx4desp32_ESP32_P4_70CT_CLB gfx = gfx4desp32_ESP32_P4_70CT_CLB();
#include "gfx4desp32_ESP32P4_101CT.h"

gfx4desp32_ESP32P4_101CT gfx = gfx4desp32_ESP32P4_101CT();
//#include "gfx4desp32_ESP32P4_70CT.h"
//gfx4desp32_ESP32P4_70CT gfx = gfx4desp32_ESP32P4_70CT();

//#include "gfx4desp32_ESP32P4_80CT.h"

//gfx4desp32_ESP32P4_80CT gfx = gfx4desp32_ESP32P4_80CT();
...
void loop()
{
  ...
  if (TOUCHED == TOUCH_PRESSED)
  {
    ...
    else
    {
      ...
      gfx.LineAA(lastTx, lastTy, tx, ty, 6, BLUE);
    }
  ...
  {
    gfx.CircleFilledAA(tx, ty, 5, RED);
    firstTouch = true;
  }
}
